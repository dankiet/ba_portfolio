...
**Business Analyst | Operations Specialist | Digital Marketing | IT Support**

📧 kietkiet.dan@gmail.com | 📱 (+84) 909-888951 | 📍 Ho Chi Minh City, Vietnam  
🔗 GitHub: [github.com/dankiet](https://github.com/dankiet)

---

## PROFESSIONAL SUMMARY

Versatile professional with 8+ years across retail operations, digital marketing, and IT systems. Proven track record in process optimization, data analysis, and cross-functional execution. Currently completing Business Analysis training at Hai Lúa Academy to formalize analytical capabilities and transition into BA roles. Skilled at bridging business needs with technical solutions through hands-on experience in operations management, performance marketing, and system administration.

**Career Objectives:**
- **Short-term**: Leverage operational and technical background to gain practical experience as a Business Analyst, focusing on requirements gathering, process mapping, and stakeholder collaboration in retail/FMCG/e-commerce domains.
- **Long-term**: Progress to Senior Business Analyst or Product Owner role, driving digital transformation initiatives and leading cross-functional teams to deliver data-driven solutions that optimize business operations and customer experience.

---

## CORE COMPETENCIES

**Business Analysis**: Requirements Elicitation • Process Mapping • Data Analysis • Stakeholder Management • UAT Coordination • Documentation (BRD/FRD)

**Operations & Commercial**: Demand Forecasting • Inventory Management • Multi-site Operations • Trade Marketing • Sales Analytics • Process Optimization

**Digital Marketing**: Performance Marketing • Paid Ads (Google/Meta/TikTok) • Conversion Optimization • SEO/SEM • Marketing Automation • CRM Strategy • E-commerce Growth • Funnel Analysis

**Technology & Systems**: System Administration • Network Security • Help Desk Management • ERP Implementation • Process Automation • Data Engineering

**Tools & Platforms**: Google Ads • Facebook Ads Manager • Google Analytics (GA4) • Google Tag Manager • Power BI • Looker Studio • Python • Excel (Power Query/VBA) • SQL (basic) • Bitrix24 • HubSpot • Odoo ERP • WordPress • JIRA • Confluence • Canva • Google Workspace
...
- Designed BPMN diagrams (AS-IS/TO-BE) with Pool/Lane structure
- Built Use Case Diagrams with System Boundary
- Created Activity Diagrams with Swimlanes and State Diagrams
- Documented ERD, API specifications, and Interface specs
- Compiled IEEE 830 compliant SRS documents
- Maintained 100% traceability: Requirements → Code → Test
...
Nguyen Tat Thanh University • 2011 – 2014
...
**Business Analysis**: Requirements gathering and documentation • Stakeholder interviews • Process modeling (BPMN basics) • User story writing • Gap analysis • UAT support

**Data Analysis**: Excel advanced (Power Query, Pivot, VBA) • Power BI dashboard design • SQL queries (basic) • Data visualization • Statistical analysis basics

**Project Coordination**: Agile/Scrum fundamentals • Project documentation • Cross-functional collaboration • Timeline management

**Languages**: Vietnamese (Native) • English (Professional working proficiency - reading technical docs, writing reports, business communication)

---

## ADDITIONAL INFORMATION

Open to relocation and business travel. Seeking Business Analyst, Operations Analyst, or Commercial Operations roles in Retail/FMCG/Distribution/E-commerce where analytical mindset, operational experience, and technical aptitude can drive measurable business outcomes.